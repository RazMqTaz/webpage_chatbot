...
@click.command()
@click.option("--input-file", default="data/crawled_pages.txt", show_default=True, help="Path to file containing list of URLs to scrape")
@click.option("--output-dir", default="data/scraped_data", show_default=True, help="Directory to save scraped text data")
